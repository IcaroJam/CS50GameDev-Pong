...
function displayScore()
	...
	love.graphics.printf(tostring(player1Score), 0, VIRTUAL_HEIGHT / 5, VIRTUAL_WIDTH / 2,
		"center")
	love.graphics.printf(tostring(player2Score), VIRTUAL_WIDTH / 2, VIRTUAL_HEIGHT / 5,
